    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.openAddStudentScreen();
            }
        });

        student = (StudentList) getArguments().getSerializable("List_of_Student");

 /*Init recycler view*/
        recyclerView = (RecyclerView) view.findViewById(R.id.all_student_list);
        studentListAdapter = new StudentListAdapter();
        studentListAdapter.setStudentList(student.getStudentList());
